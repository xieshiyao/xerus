...
UNIT_TEST(SparseTensor, Assignment_Sparse_To_Sparse, 
    ...
    res(i,j,k,l,m) = A(i,j,k,l,m);
    TEST(Tensor(res).compare_to_data({1,0,0,4,0,0,0,8,0,0,11,0,0,14,0,0,0,0,19,0,0,0,23,0}));
    ...
    TEST(Tensor(res).compare_to_data({1,0,0,4,0,0,0,14,0,0,0,0,0,8,0,0,11,0,19,0,0,0,23,0}));
    res(j,i,k,l,m) = A(i,j,k,l,m);
    TEST(Tensor(res).compare_to_data({1,0,0,4,0,0,0,14,0,0,0,0,0,8,0,0,11,0,19,0,0,0,23,0}));
    
    res2(i,k,j,l,m) = A(i,j,k,l,m);
    TEST(Tensor(res2).compare_to_data({1,0,0,8,0,4,0,0,0,0,11,0,0,14,19,0,0,0,0,0,0,0,23,0}));
