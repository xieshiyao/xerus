...
static misc::UnitTest tensor_fix_slate("Tensor", "fix_slate", [](){
	std::mt19937_64 rnd;
	rnd.seed(0X5EED);
...
static misc::UnitTest tensor_dim_reduc("Tensor", "dimension_reduction", [](){
    Tensor A({2,2,2});
    A[{0,0,0}] = 1;
    A[{0,0,1}] = 2;
    A[{0,1,0}] = 3;
...
static misc::UnitTest tensor_dim_exp("Tensor", "dimension_expansion", [](){
    Tensor A({2,2,2});
    A[{0,0,0}] = 1;
    A[{0,0,1}] = 2;
    A[{0,1,0}] = 3;
