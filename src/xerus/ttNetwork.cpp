...
// 	}
	...
	namespace misc {
		...
		template<bool isOperator>
		void write_to_stream_helper(std::ostream &_stream, const TTNetwork<isOperator> &_obj, const FileFormat _format) {
		...
		void write_to_stream(std::ostream &_stream, const TTNetwork<true> &_obj, const FileFormat _format) {
			write_to_stream_helper<true>(_stream, _obj, _format);
		}
		template<>
		void write_to_stream(std::ostream &_stream, const TTNetwork<false> &_obj, const FileFormat _format) {
			write_to_stream_helper<false>(_stream, _obj, _format);
		}
		
		template<bool isOperator>
		void read_from_stream_helper(std::istream& _stream, TTNetwork<isOperator> &_obj, const FileFormat _format) {
		...
		void read_from_stream(std::istream& _stream, TTNetwork<true> &_obj, const FileFormat _format) {
			read_from_stream_helper<true>(_stream, _obj, _format);
		}
		template<>
		void read_from_stream(std::istream& _stream, TTNetwork<false> &_obj, const FileFormat _format) {
			read_from_stream_helper<false>(_stream, _obj, _format);
		}
	}
}
